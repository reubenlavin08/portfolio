(() => {
  ...
  const PROJECTS = {
    ...
    sorta: {
      tag: 'Software · In progress',
      title: 'Sorta — Desktop File Organizer',
      desc: "A personal app I'm building to keep a Windows PC tidy automatically — sorting downloads, screenshots, and stray files into the right folders by type, date, and rules I define. Born out of frustration watching my own desktop spiral out of control.",
      bullets: [
        'Rule-based file classification and automatic routing to the correct folder',
        'Designed to run quietly in the background, not as a one-off cleanup script',
        'Active project — adding features as I discover new pain points',
      ],
      stack: ['Active development'],
      github: null,
      gallery: [],
    },
  };
